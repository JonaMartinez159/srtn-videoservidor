<div>
    <div class="w-full bg-white dark:bg-gray-800 border-gray-200 border dark:border-gray-700 shadow-sm rounded-lg p-5">
        <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Enlaces del servicio</h2>
        <p class="text-gray-500 dark:text-gray-400 mb-6"></p>
        <label for="account-id" class="text-sm font-medium text-gray-900 dark:text-white mb-2 block">Enlace de publicacion</label>
        ...
        <label for="api-key" class="text-sm font-medium text-gray-900 dark:text-white mb-2 block">Consumo HLS</label>
        <div class="relative mb-4">
        ...
        <label for="role-arn" class="text-sm font-medium text-gray-900 dark:text-white mb-2 block">Consumo pagina web</label>

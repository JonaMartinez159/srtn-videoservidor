<div>
    <div class="w-full bg-white dark:bg-gray-800 border-gray-200 border dark:border-gray-700 shadow-sm rounded-lg p-5">
        ...
        <div class="relative mb-4">
            ...
            <button wire:click="$js.copypublicacion()" data-copy-to-clipboard-target="account-id" data-tooltip-target="tooltip-account-id" class="absolute end-2 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg p-2 inline-flex items-center justify-center">
        ...
        <div class="relative mb-4">
            ...
            <button wire:click="$js.copyreproduccionexterna()" data-copy-to-clipboard-target="account-id" data-tooltip-target="tooltip-account-id" class="absolute end-2 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg p-2 inline-flex items-center justify-center">
                <span id="default-icon-account-id">
                    <svg class="w-3.5 h-3.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                        <path d="M16 1h-3.278A1.992 1.992 0 0 0 11 0H7a1.993 1.993 0 0 0-1.722 1H2a2 2 0 0 0-2 2v15a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2Zm-3 14H5a1 1 0 0 1 0-2h8a1 1 0 0 1 0 2Zm0-4H5a1 1 0 0 1 0-2h8a1 1 0 1 1 0 2Zm0-5H5a1 1 0 0 1 0-2h2V2h4v2h2a1 1 0 1 1 0 2Z"/>
                    </svg>
        ...
        <label for="api-key" class="text-xs font-medium text-gray-900 dark:text-white mb-2 block">Consumo HLS</label>
        <div class="relative mb-4">
            <input id="api-key" type="text" class="col-span-6 bg-gray-50 border border-gray-300 text-gray-500 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{$datos_de_servicio['enlace_consumo_hls']}}" disabled readonly>
            <button wire:click="$js.copyconsumohls()" data-copy-to-clipboard-target="api-key" data-tooltip-target="tooltip-api-key" class="absolute end-2 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg p-2 inline-flex items-center justify-center">
        ...
        <label for="role-arn" class="text-xs font-medium text-gray-900 dark:text-white mb-2 block">Consumo pagina web</label>
        <div class="relative mb-6">
            <input id="role-arn" type="text" class="col-span-6 bg-gray-50 border border-gray-300 text-gray-500 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{$datos_de_servicio['enlace_consumo_web']}}" disabled readonly>
            <button wire:click="$js.copyconsumoweb()" data-copy-to-clipboard-target="role-arn" data-tooltip-target="tooltip-role-arn" class="absolute end-2 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg p-2 inline-flex items-center justify-center">
...
<script>
    $js('copypublicacion', () => {
        console.log(@this.datos_de_servicio['enlace_publicacion']);
        navigator.clipboard.writeText(@this.datos_de_servicio['enlace_publicacion']);
        alert("Enlace Copiado");
    })
    $js('copyreproduccionexterna', () => {
        console.log(@this.datos_de_servicio['enlace_reproduccion_externa']);
        navigator.clipboard.writeText(@this.datos_de_servicio['enlace_reproduccion_externa']);
        alert("Enlace Copiado");
    })
    $js('copyconsumohls', () => {
        console.log(@this.datos_de_servicio['enlace_consumo_hls']);
        navigator.clipboard.writeText(@this.datos_de_servicio['enlace_consumo_hls']);
        alert("Enlace Copiado");
    })
    $js('copyconsumoweb', () => {
        console.log(@this.datos_de_servicio['enlace_consumo_web']);
        navigator.clipboard.writeText(@this.datos_de_servicio['enlace_consumo_web']);
        alert("Enlace Copiado");
    })
</script>
@endscript

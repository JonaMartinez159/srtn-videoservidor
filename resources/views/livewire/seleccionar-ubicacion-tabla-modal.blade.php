                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        @foreach ($ubicaciones as $ubicacion)
                            <tr wire:key="{{ $ubicacion->id }}" wire:click="setUbicacion('{{ $ubicacion->ubicacion }}')" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <td class="w-4 p-4">
                                    <div class="flex items-center">

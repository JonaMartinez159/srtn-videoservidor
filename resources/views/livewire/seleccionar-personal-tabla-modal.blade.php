<div>
    ...
    <div class="flex -space-x-4 rtl:space-x-reverse p-3">
        ...
        @if ($array_trabajadores_seleccionados != null)
            @foreach ($array_trabajadores_seleccionados as $trabajadores_seleccionados)
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    @foreach ($trabajadores as $trabajador)
                        <tr wire:key="{{ $trabajador->id }}" wire:click="setChecked({{ $trabajador->id }})" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                            <td class="w-4 p-4">
                                <div class="flex items-center">

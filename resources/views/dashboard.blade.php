<x-app-layout>
    <div class="grid lg:grid-cols-12 gap-3">
        <div class="col-span-10 col-start-2 h-full">
            <div class="grid md:grid-cols-3 h-fit gap-4">
                <div class="md:col-span-1 h-full p-6 bg-white rounded-xl">

                    <div class="w-full bg-white rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                        <div class="flex justify-end px-4 pt-4">
                            ...
                            <div id="dropdown" class="z-10 hidden text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700">
                                ...
                                <li>
                                    <a href="{{ route('profile.show')}}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Editar</a>
                                </li>
                                <li>
                                    <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Reportar</a>
                                </li>
                                </ul>
                            </div>
                        </div>
                        <div class="flex flex-col items-center pb-8">
                            ...
                            <h5 class="mb-1 text-lg font-medium text-gray-900 dark:text-white">{{auth()->user()->name}}</h5>
                ...
                <div class="md:col-span-2 h-full">
                    <div class="grid lg:grid-cols-2 gap-2 h-full">
                        <div>
                            <a href="{{ route('nuevatransmision')}}" class="block h-full p-2 bg-gradient-to-r from-violet-600 to-indigo-600 text-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                                <span class="text-white text-xs font-medium mt-2 px-2.5 rounded-full dark:bg-gray-700 dark:text-gray-300">Comienza</span>
                                
                                <h5 class="mt-5 px-4 text-2xl font-bold tracking-tight dark:text-white">Registra un nuevo evento</h5>
                                <p class="font-normal px-4 mt-2 text-xs text-gray-300">Para proximas transmisiones o grabaciones</p>
                                <div class="h-full w-full flex align-items-end justify-end">
                                    <svg class="w-auto max-w-[16rem] h-20 px-4 mt-2 text-gray-800 dark:text-white" aria-hidden="true" width="506" height="575" viewBox="0 0 506 575" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div>
                            <a href="{{ route('transmisiones') }}" class="block h-full p-2 bg-gradient-to-r from-emerald-500 to-emerald-900 text-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                                <span class="text-white text-xs font-medium mt-2 px-2.5 rounded-full dark:bg-gray-700 dark:text-gray-300">Comienza</span>
                                
                                <h5 class="mt-5 px-4 text-2xl font-bold tracking-tight dark:text-white">Ver transmisiones actuales</h5>
                                <p class="font-normal px-4 mt-2 text-xs text-gray-300">visualiza las transmisiones</p>
                                <div class="h-full w-full flex align-items-end justify-end">
                                    <svg class="w-auto max-w-[16rem] h-20 px-4 mt-2 text-gray-800 dark:text-white" aria-hidden="true" width="627" height="499" viewBox="0 0 627 499" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="md:col-span-3 p-6 bg-white rounded-xl">
                    ...
                    <div id="default-tab-content">
                        <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            ...
                            @livewire('ActividadReciente')
                        </div>
                        <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                            <p class="text-sm text-gray-700">No tienes notificaciones</p>
                        </div> 
                    </div>

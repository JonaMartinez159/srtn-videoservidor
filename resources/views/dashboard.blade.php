<x-app-layout>
    <div class="px-4 max-w-screen-xl">
        ...
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12 mb-8">
            ...
            <h1 class="text-gray-900 dark:text-white text-3xl md:text-3xl font-extrabold mb-2">Registrar una nueva transmisión o grabacion</h1>
            <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-6">Si tienes una transmisión o grabación proxima registrala aquí, para mantener informado a todo el equipo de produccion, ingeniería y dirección</p>
            @livewire('RegistrarTransmision')
        </div>
        @endrole
